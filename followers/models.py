...
class Follow(db.Model):
    ...
    from_user_id = db.Column(db.String(), db.ForeignKey('user.id'), nullable=False) # initiating follow
    to_user_id = db.Column(db.String(), db.ForeignKey('user.id'), nullable=False) # being followed
